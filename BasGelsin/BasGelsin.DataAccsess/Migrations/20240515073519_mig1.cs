        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MersisNumber = table.Column<int>(type: "int", nullable: true),
                    ...
                    EmailProofToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmailProofTokenExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SignToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromationId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PromotionProducts_Promotions_PromationId",
                        column: x => x.PromationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionProducts_PromationId",
                table: "PromotionProducts",
                column: "PromationId");
